...
class Bee(Insect):
    ...
    def action(self, colony):
        ...
        # BEGIN Problem EC
        "*** YOUR CODE HERE ***"
        if self.scared or not self.backward:
            destination = self.place.exit
        else:
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        "*** YOUR CODE HERE ***"
        place = self.place
        bees_group = list(place.bees)
        Ant.reduce_armor(self, amount)
        if place.ant == None:
            for each_bee in bees_group:
                each_bee.reduce_armor(self.damage + amount)
        else:
            for each_bee in bees_group:
...
class NinjaAnt(Ant):
    ...
    def action(self, colony):
        # BEGIN Problem 7
        "*** YOUR CODE HERE ***"
        bees_group = list(self.place.bees) #Create bees list
        for each_bee in bees_group: #Reduce the armor by the ant damage
...
class BodyguardAnt(Ant):
    ...
    def contain_ant(self, ant):
        # BEGIN Problem 9
        "*** YOUR CODE HERE ***"
        self.contained_ant = ant #Let the leaf be the ant
        # END Problem 9

    def action(self, colony):
        # BEGIN Problem 9
        "*** YOUR CODE HERE ***"
        if self.contained_ant != None: #Iterate the action if there exists leaf
...
class TankAnt(BodyguardAnt):
    ...
    def action(self, colony):
        # BEGIN Problem 10
        "*** YOUR CODE HERE ***"
        bees_group = list(self.place.bees) #Create a list of bees
        if self.contained_ant != None: #Iterate the action if there exists container ant
            self.contained_ant.action(colony)
        for each_bee in bees_group: #Then reduce the armor of the bees by damage
            each_bee.reduce_armor(self.damage)
        # END Problem 10
...
class Water(Place):
    ...
    def add_insect(self, insect):
        ...
        # BEGIN Problem 11
        "*** YOUR CODE HERE ***"
        Place.add_insect(self, insect) #To add the insect first
        if not insect.is_watersafe: #Then check whether the insect is watersafe or not
...
# END Problem 13
    ...
    def action(self, colony):
        ...
        if self.impostor_Queen:
            ...
            while place_behind:
                if place_behind.ant and place_behind.ant != None:
                    if place_behind.ant.is_container and place_behind.ant.contained_ant and place_behind.ant.contained_ant not in self.double_damage:
                        place_behind.ant.contained_ant.damage *= 2
                        self.double_damage.append(place_behind.ant.contained_ant)
                    if place_behind.ant not in self.double_damage:
                        place_behind.ant.damage *= 2
                        self.double_damage.append(place_behind.ant)
    ...
    def reduce_armor(self, amount):
        ...
        if not self.impostor_Queen and self.armor <= 0:
            bees_win()
        # END Problem 13
...
def make_scare(action, bee):
    ...
    bee.scared = False
    bee.backward = True
    return lambda colony: action(colony)
    # END Problem EC
...
def apply_effect(effect, bee, duration):
    ...
    rest_action = effect(first_action, bee)
