    ...
    def getObservationProb(self, noisyDistance, pacmanPosition, ghostPosition, jailPosition):
        ...
        if noisyDistance is None:
            ...
            if jailPosition == ghostPosition:
                ...
                manhDist = manhattanDistance(pacmanPosition, ghostPosition)
                return busters.getObservationProbability(noisyDistance, manhDist)
    ...
    def elapseTime(self, gameState):
        ...
        for oldPos in self.allPositions:
            ...
            for newPos in newPosDist:
                discreteDist[newPos] += newPosDist[newPos] * self.beliefs[oldPos]
...
class ParticleFilter(InferenceModule):
    ...
    def elapseTime(self, gameState):
        ...
        for particle in self.particles:
            ...
            distributions.append(newPosDist.sample())
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for particle in self.particles:
            ...
            for i in range(self.numGhosts):
                ...
                updateValue *= self.getObservationProb(observation[i], pacmanPosition, particle[i], jailPosition)
            distributions[particle] += updateValue

        distributions.normalize()
        if distributions.total() == 0:
            self.initializeUniformly(gameState)
        else:
            self.particles = [distributions.sample() for _ in range(self.numParticles)]
